...
class Komentator {
    ...
    public final SluchaczZdarzen powiadomODojsciuDoMety = (Uczestnik u) -> {
        ...
        mow( slowo_uczestnik+" "+u+" jest już na mecie!");
    };
    ...
    public void relacjonuj(int nrElementu, Uczestnik u, DziedzinaZadania dz)
    {
        String slowo_uczestnik = odmienUczestnik(u);
        slowo_uczestnik = slowo_uczestnik.substring(0, 1).toUpperCase() + slowo_uczestnik.substring(1);
        mow( slowo_uczestnik+" "+u+" wykonuje teraz zadanie z "+dz+". Element nr "+nrElementu+" trasy.");
    }
